    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={marblesAndJokers}
              isBlog={false}
              title="Marbles and Jokers"
              description="My brother creating a board game and needed a sticker for the boxes. Working with him and taking feedback on the design resulted in a logo that he loved and adds some flair to his boxes!"
              ghLink=""
              demoLink=""
            />
          </Col>
